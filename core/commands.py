...
class Commands(commands.Cog):
    ...
    @requires_perms(owner=False)
    async def update_weapons(self, ctx):
    ...
    @requires_perms(owner=False)
    async def set_debug_channel(self, ctx):
    ...
    @requires_perms(owner=False)
    async def set_announcements(self, ctx):
    ...
    @requires_perms(owner=False)
    async def add_react_role(self, ctx, emoji: str, *_):
    ...
    @requires_perms(owner=False)
    async def set_maps_channel(self, ctx):
    ...
    @requires_perms(owner=False)
    async def set_sr_channel(self, ctx):
    ...
    @requires_perms(owner=False)
    async def set_challenge_channel(self, ctx):
    ...
    @requires_perms(owner=False)
    async def set_gear_channel(self, ctx):
        """ Set challenge schedule embed to this channel """
    ...
    @requires_perms(owner=False)
    async def set_anarchy_role(self, ctx, _):
        roles = ctx.message.role_mentions
        if roles:
    ...
    @requires_perms(owner=False)
    async def set_sr_role(self, ctx, _):
        roles = ctx.message.role_mentions
        if roles:
    ...
    @requires_perms(owner=False)
    async def splatfest_setup(self, ctx, team1, color1, team2, color2, team3, color3):
    ...
    @requires_perms(owner=True)
    async def reset_server(self, ctx, server_id=None):
